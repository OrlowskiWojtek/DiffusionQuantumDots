...
void DiffusionQuantumParams::set_default_params() {
    ...
    equi_d_tau = d_tau;        // qfter equilibrium time step
    total_time_steps = 100000; // total number of time steps valued d_tau
    eq_time_step = 70000;     // time step to average from
